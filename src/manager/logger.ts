// Source: https://github.com/UwUCode/Logger/blob/master/lib/index.ts
// Yes, I just didnt want the @uwu-codes bit so lmao
// also for a bit of customisation ig, for eg moving from american date to YYYY-MM-DD
