...
export default new Command(CommandType.Application, { cmd: ["notification", "mission", "delete"], permissionsMember: ["MANAGE_GUILD"], exceptionPermissionsCheck: [[-1, ""]], description: "Deletes a rally notification.", cooldown: 3000 })
    .attach('run', async ({ client, interaction }) => {
        ...
        return interaction.reply({
            embeds: [{
                ...
                description: `Arcade Role: <@&${roles[0] === "U" ? "N/A" : roles[0]}>.\nBounty Role: <@&${roles[1] === "U" ? "N/A" : roles[1]}.`,
                fields: [{
                    name: "Type",
                    value: "Daily Missions Reset",
                    inline: true
                }, {
                    name: "Channel",
